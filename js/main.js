 ...
 jQuery(document).ready(function() {
    ...
    function initialize() {
            var mapOptions = {
                ...
                center: new google.maps.LatLng(41.8877177, -87.6302763)
            };
	...
	// twitter script
	jQuery('.tweet-feed .tweet').twittie({
		dateFormat: '%b. %d, %Y',
		template: ' <div class="media"><div class="avatar media-left"><a href="http://twitter.com/themerobian" target="_blank"<i class="twitter-avatar fa fa-twitter"></i> </a></div> <div class="twt-area media-body"><div class="screen-name">{{screen_name}} </div> {{tweet}} <div class="url-s"> </div> </div> <div class="date">{{date}}</div>',
		count: 3,
